...
export default class Constants {
    ...
    public static ICONS = {
        ...
        CONTACT_DETAILS_ICON : {iconName: "AddLink",  style: { fontSize: 22, color: '#fff' }},
        PPT: {iconName: "PowerPointDocument", style: {fontSize: 15,color:'#FCAF1A'}},
        EMAIL: {iconName: "Mail", style: {fontSize: 15,color:'#80539C'}},
        LINK: {iconName: "Link", style: {fontSize: 15,color:'#5A2A82'}},
